"""
ise_get-all-endpoints.py: Collect endpoints info frome Cisco ISE Server
...
if __name__ == '__main__':
    ...
    # script arguments
    parser: ArgumentParser = ArgumentParser(description='Collect endpoints info frome Cisco ISE Server')
